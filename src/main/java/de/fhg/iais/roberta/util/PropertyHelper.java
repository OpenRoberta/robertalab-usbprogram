...
public final class PropertyHelper {
    ...
    private static final String DEFAULT_PROPERTY_NAME = "OpenRobertaUSB.properties";

    private final Properties properties = new Properties();

    private PropertyHelper() {
        try {
            this.properties.load(getClass().getClassLoader().getResourceAsStream(DEFAULT_PROPERTY_NAME));
        } catch ( IOException e ) {
